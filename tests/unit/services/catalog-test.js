...
/*Its lookup method retrieves the referred entity from the registry. service:catalog,
controller:bands/new, and component:star-rating are valid values, the first part denoting the
"type" of the entity we want to fetch. */
