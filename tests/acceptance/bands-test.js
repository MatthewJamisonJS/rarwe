...
module('Acceptance | bands', function (hooks) {
  ...
  setupMirage(hooks);
  /*Where we set up application for acceptance tests*/
...
/*We tell it to create two bands, passing an object with the properties to create the object with.
    The new assertions now verify the page from the user's perspectives */
